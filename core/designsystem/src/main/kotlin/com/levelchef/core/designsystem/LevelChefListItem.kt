...
fun LevelChefListItem(
    ...
    Row(
        modifier = modifier.fillMaxWidth().background(BackgroundSurface).padding(horizontal = 16.dp, vertical = 14.dp),
        ...
        Column(modifier = Modifier.weight(1f), verticalArrangement = Arrangement.spacedBy(2.dp)) {
            ...
            Text(subtitle, color = TextSecondary, style = LevelChefTextStyles.bodySmall)
        }
