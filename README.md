...
- **`core:ui`** — Compose theme (`Color`/`Theme`/`Type`) built from the design's dark palette (`#0f0f1a` background, `#534AB7` accent, flat/no-shadow cards, 12px radius, 0.5px borders).
